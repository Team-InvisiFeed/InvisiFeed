        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl font-bold text-white mb-6">
              Try InvisiFeed with a <p className="text-yellow-400">Sample Invoice</p>
            </h2>
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-800">SAMPLE INVOICE</h3>
                  </div>
                ...
                <div className="border-t border-gray-200 pt-4 flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2 bg-yellow-50 px-3 py-2 rounded-md">
                    ...
                    <span className="text-sm font-medium text-yellow-600">Scan for feedback</span>
                  </div>
                </div>
              </div>
            </div>
